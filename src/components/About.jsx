          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 mb-12">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-300 leading-relaxed text-base md:text-lg">
                I'm a Software Engineer specializing in <span className="text-teal-400 font-semibold">Ruby on Rails</span> and <span className="text-teal-400 font-semibold">Workato automation</span>, with a proven track record of delivering scalable web applications and enterprise integrations.
              </p>
              <p className="text-gray-300 leading-relaxed text-base md:text-lg">
